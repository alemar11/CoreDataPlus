...
/// @Note The Swift version returns an *Array* and for performance issues you should prefer using an éNSArray* **for batched requests**: https://developer.apple.com/forums/thread/651325 .
