...
> CocoaPods 1.1.0+ is required to build CoreDataPlus 0.7.0+.
...
```ogdl
github "tinrobots/CoreDataPlus" ~> 0.7.0
```
...
```swift
dependencies: [
    .package(url: "https://github.com/tinrobots/CoreDataPlus.git", from: "0.7.0")
]
```
